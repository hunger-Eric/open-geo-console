...
const mocks = vi.hoisted(() => ({
  getGeoReport: vi.fn(), getActivePaymentOrderForReport: vi.fn(), createPaymentOrder: vi.fn(),
  attachHostedCheckout: vi.fn(), replaceLegacyHostedCheckout: vi.fn(), verifyTurnstile: vi.fn(),
  createHostedCheckout: vi.fn(), getHostedCheckout: vi.fn(), findHostedCheckoutByReference: vi.fn(),
  deactivateLegacyHostedCheckout: vi.fn(), assertRecommendationProductAvailable: vi.fn()
}));
