...
export const zh = {
  ...
  commerce: {
    ...
    unavailableConfiguration: "当前部署的在线购买配置不完整。",
    unavailableCapacity: "当前交付能力不可用，在线购买已暂停。",
    unavailableIncident: "支付服务正在处理异常，在线购买暂时暂停。",
    unavailableProduct: "当前部署配置暂不支持这项深度报告产品。",
    unavailableInternal: "系统暂时无法安全判断购买目录状态，请稍后重试。",
    ...
    paymentRefundPending: "全额退款正在排队处理，尚未提交至支付机构。",
    paymentRefundSubmitted: "全额退款已提交，正在等待支付机构确认。",
