...
export const en = {
  ...
  commerce: {
    ...
    unavailableConfiguration: "Online purchase configuration is incomplete for this deployment.",
    unavailableCapacity: "Online purchase is paused because fulfillment capacity is unavailable.",
    unavailableIncident: "Online purchase is temporarily paused while a commerce incident is handled.",
    unavailableProduct: "The deep-report product is not available for this deployment configuration.",
    unavailableInternal: "The purchase catalog could not be evaluated safely. Please try again later.",
    ...
    paymentRefundPending: "The full refund is queued but has not yet been submitted to the payment provider.",
    paymentRefundSubmitted: "The full refund has been submitted and is awaiting provider confirmation.",
