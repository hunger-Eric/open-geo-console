...
function copy(template: EmailTemplate, zh: boolean, order: string, site: string) {
  switch (template) {
    ...
    case "corrected_report_ready": return zh
      ? { subject: `\u4fee\u6b63\u540e\u7684\u5408\u5e76\u62a5\u544a\u5df2\u5b8c\u6210 \u00b7 ${order}`, heading: "\u4fee\u6b63\u62a5\u544a\u5df2\u5b8c\u6210", body: "\u4e09\u4e2a\u4e1a\u52a1\u95ee\u9898\u3001\u516c\u5f00\u6765\u6e90\u8bc1\u636e\u3001\u5b8c\u6574\u6280\u672f\u5206\u6790\u548c\u540c\u6e90 PDF \u5df2\u901a\u8fc7\u9a8c\u8bc1\u3002\u8bf7\u4f7f\u7528\u4e0b\u9762\u7684\u5b89\u5168\u94fe\u63a5\u6253\u5f00\u65b0\u7684\u5408\u5e76\u62a5\u544a\u3002" }
      : { subject: `Your corrected combined report is ready \u00b7 ${order}`, heading: "Your corrected report is ready", body: "The three business questions, public-source evidence, complete technical analysis, and same-source PDF passed verification. Open the new combined report using the secure link below." };
