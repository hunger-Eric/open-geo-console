...
function copy(template: EmailTemplate, zh: boolean, order: string, site: string) {
  switch (template) {
    ...
    case "corrected_report_ready": return zh
      ? { subject: `\u4fee\u6b63\u540e\u7684\u5408\u5e76\u62a5\u544a\u5df2\u5b8c\u6210 \u00b7 ${order}`, heading: "\u4fee\u6b63\u62a5\u544a\u5df2\u5b8c\u6210", body: "\u4e09\u4e2a\u4e1a\u52a1\u95ee\u9898\u3001\u516c\u5f00\u6765\u6e90\u8bc1\u636e\u548c\u5b8c\u6574\u6280\u672f\u5206\u6790\u5df2\u901a\u8fc7\u9a8c\u8bc1\u3002\u8bf7\u4f7f\u7528\u4e0b\u9762\u7684\u5b89\u5168\u94fe\u63a5\u6253\u5f00\u65b0\u7684\u5408\u5e76 HTML \u62a5\u544a\u3002" }
      : { subject: `Your corrected combined report is ready \u00b7 ${order}`, heading: "Your corrected report is ready", body: "The three business questions, public-source evidence, and complete technical analysis passed verification. Open the new combined HTML report using the secure link below." };
    case "replacement_report_ready": return zh
      ? { subject: `\u514d\u8d39\u8865\u4ea4\u7684\u6df1\u5ea6\u62a5\u544a\u5df2\u5b8c\u6210 \u00b7 ${order}`, heading: "\u60a8\u7684\u62a5\u544a\u5df2\u8865\u4ea4", body: "\u4e0a\u4e00\u6b21\u672a\u80fd\u4ea4\u4ed8\u7684 V3 \u62a5\u544a\u5df2\u4f5c\u4e3a\u514d\u8d39\u66ff\u4ee3\u5c65\u7ea6\u5b8c\u6210\uff0c\u65e0\u9700\u518d\u6b21\u4ed8\u6b3e\u3002\u8bf7\u4f7f\u7528\u4e0b\u9762\u7684\u5b89\u5168\u94fe\u63a5\u6253\u5f00\u5408\u5e76 HTML \u62a5\u544a\u3002" }
      : { subject: `Your complimentary replacement report is ready \u00b7 ${order}`, heading: "Your replacement report is ready", body: "The V3 report that was not delivered previously is now complete as a complimentary replacement fulfillment. No additional payment is required. Open the combined HTML report using the secure link below." };
