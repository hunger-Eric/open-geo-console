...
import { V35_DATABASE_MIGRATIONS, V36_DATABASE_MIGRATIONS, V37_DATABASE_MIGRATIONS, V38_DATABASE_MIGRATIONS, V39_DATABASE_MIGRATIONS, V40_DATABASE_MIGRATIONS, V41_DATABASE_MIGRATIONS, V42_DATABASE_MIGRATIONS, V43_DATABASE_MIGRATIONS, V44_DATABASE_MIGRATIONS, V45_DATABASE_MIGRATIONS, V46_DATABASE_MIGRATIONS, V47_DATABASE_MIGRATIONS, databaseMigrationsAfter } from "./migrations";
...
describe("schema V35 protected-Staging acceptance ledger", () => {
  it("registers one forward-only append-only ledger migration after V34", () => {
    ...
    expect(databaseMigrationsAfter(34)).toEqual([...V35_DATABASE_MIGRATIONS, ...V36_DATABASE_MIGRATIONS, ...V37_DATABASE_MIGRATIONS, ...V38_DATABASE_MIGRATIONS, ...V39_DATABASE_MIGRATIONS, ...V40_DATABASE_MIGRATIONS, ...V41_DATABASE_MIGRATIONS, ...V42_DATABASE_MIGRATIONS, ...V43_DATABASE_MIGRATIONS, ...V44_DATABASE_MIGRATIONS, ...V45_DATABASE_MIGRATIONS, ...V46_DATABASE_MIGRATIONS, ...V47_DATABASE_MIGRATIONS]);
