...
import { V36_DATABASE_MIGRATIONS, V37_DATABASE_MIGRATIONS, V38_DATABASE_MIGRATIONS, V39_DATABASE_MIGRATIONS, V40_DATABASE_MIGRATIONS, V41_DATABASE_MIGRATIONS, V42_DATABASE_MIGRATIONS, V43_DATABASE_MIGRATIONS, databaseMigrationsAfter } from "./migrations";
...
describe("schema V36 protected-acceptance site-read manifest", () => {
  it("registers one forward-only hash-only manifest migration after V35", () => {
    ...
    expect(databaseMigrationsAfter(35)).toEqual([...V36_DATABASE_MIGRATIONS, ...V37_DATABASE_MIGRATIONS, ...V38_DATABASE_MIGRATIONS, ...V39_DATABASE_MIGRATIONS, ...V40_DATABASE_MIGRATIONS, ...V41_DATABASE_MIGRATIONS, ...V42_DATABASE_MIGRATIONS, ...V43_DATABASE_MIGRATIONS]);
