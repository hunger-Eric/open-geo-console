...
describe("database schema marker", () => {
  ...
  it("runs only forward migrations when upgrading an existing schema", () => {
    expect(databaseMigrationsAfter(21)).toEqual([...V22_DATABASE_MIGRATIONS, ...V23_DATABASE_MIGRATIONS, ...V24_DATABASE_MIGRATIONS, ...V25_DATABASE_MIGRATIONS, ...V26_DATABASE_MIGRATIONS, ...V27_DATABASE_MIGRATIONS, ...V28_DATABASE_MIGRATIONS, ...V29_DATABASE_MIGRATIONS, ...V30_DATABASE_MIGRATIONS, ...V31_DATABASE_MIGRATIONS]);
    expect(databaseMigrationsAfter(22)).toEqual([...V23_DATABASE_MIGRATIONS, ...V24_DATABASE_MIGRATIONS, ...V25_DATABASE_MIGRATIONS, ...V26_DATABASE_MIGRATIONS, ...V27_DATABASE_MIGRATIONS, ...V28_DATABASE_MIGRATIONS, ...V29_DATABASE_MIGRATIONS, ...V30_DATABASE_MIGRATIONS, ...V31_DATABASE_MIGRATIONS]);
    expect(databaseMigrationsAfter(23)).toEqual([...V24_DATABASE_MIGRATIONS, ...V25_DATABASE_MIGRATIONS, ...V26_DATABASE_MIGRATIONS, ...V27_DATABASE_MIGRATIONS, ...V28_DATABASE_MIGRATIONS, ...V29_DATABASE_MIGRATIONS, ...V30_DATABASE_MIGRATIONS, ...V31_DATABASE_MIGRATIONS]);
    expect(databaseMigrationsAfter(24)).toEqual([...V25_DATABASE_MIGRATIONS, ...V26_DATABASE_MIGRATIONS, ...V27_DATABASE_MIGRATIONS, ...V28_DATABASE_MIGRATIONS, ...V29_DATABASE_MIGRATIONS, ...V30_DATABASE_MIGRATIONS, ...V31_DATABASE_MIGRATIONS]);
    expect(databaseMigrationsAfter(25)).toEqual([...V26_DATABASE_MIGRATIONS, ...V27_DATABASE_MIGRATIONS, ...V28_DATABASE_MIGRATIONS, ...V29_DATABASE_MIGRATIONS, ...V30_DATABASE_MIGRATIONS, ...V31_DATABASE_MIGRATIONS]);
    expect(databaseMigrationsAfter(26)).toEqual([...V27_DATABASE_MIGRATIONS, ...V28_DATABASE_MIGRATIONS, ...V29_DATABASE_MIGRATIONS, ...V30_DATABASE_MIGRATIONS, ...V31_DATABASE_MIGRATIONS]);
    expect(databaseMigrationsAfter(27)).toEqual([...V28_DATABASE_MIGRATIONS, ...V29_DATABASE_MIGRATIONS, ...V30_DATABASE_MIGRATIONS, ...V31_DATABASE_MIGRATIONS]);
    expect(databaseMigrationsAfter(28)).toEqual([...V29_DATABASE_MIGRATIONS, ...V30_DATABASE_MIGRATIONS, ...V31_DATABASE_MIGRATIONS]);
    expect(databaseMigrationsAfter(29)).toEqual([...V30_DATABASE_MIGRATIONS, ...V31_DATABASE_MIGRATIONS]);
    expect(databaseMigrationsAfter(30)).toEqual([...V31_DATABASE_MIGRATIONS]);
