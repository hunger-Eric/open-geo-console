...
describe("database schema marker", () => {
  ...
  it("runs only forward migrations when upgrading an existing schema", () => {
    expect(databaseMigrationsAfter(21)).toEqual([...V22_DATABASE_MIGRATIONS, ...V23_DATABASE_MIGRATIONS, ...V24_DATABASE_MIGRATIONS, ...V25_DATABASE_MIGRATIONS, ...V26_DATABASE_MIGRATIONS, ...V27_DATABASE_MIGRATIONS, ...V28_DATABASE_MIGRATIONS, ...V29_DATABASE_MIGRATIONS, ...V30_DATABASE_MIGRATIONS, ...V31_DATABASE_MIGRATIONS, ...V32_DATABASE_MIGRATIONS, ...V33_DATABASE_MIGRATIONS, ...V34_DATABASE_MIGRATIONS, ...V35_DATABASE_MIGRATIONS, ...V36_DATABASE_MIGRATIONS, ...V37_DATABASE_MIGRATIONS, ...V38_DATABASE_MIGRATIONS, ...V39_DATABASE_MIGRATIONS, ...V40_DATABASE_MIGRATIONS, ...V41_DATABASE_MIGRATIONS, ...V42_THROUGH_V44_DATABASE_MIGRATIONS]);
