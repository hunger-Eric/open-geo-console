...
import { DATABASE_MIGRATIONS, V41_DATABASE_MIGRATIONS, databaseMigrationsAfter } from "./migrations";
...
suite("schema V41 Paid V3 methodology admission", () => {
  ...
  beforeAll(async () => {
    ...
    const throughV40 = DATABASE_MIGRATIONS.slice(0, -V41_DATABASE_MIGRATIONS.length);
