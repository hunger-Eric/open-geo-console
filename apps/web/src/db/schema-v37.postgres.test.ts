...
import { V37_DATABASE_MIGRATIONS, V38_DATABASE_MIGRATIONS, V39_DATABASE_MIGRATIONS, V40_DATABASE_MIGRATIONS, V41_DATABASE_MIGRATIONS, V42_DATABASE_MIGRATIONS, V43_DATABASE_MIGRATIONS, databaseMigrationsAfter } from "./migrations";
...
describe("schema V37 DB-authoritative prohibited-operation guards", () => {
  it("registers one replay-safe forward migration after V36", () => {
    ...
    expect(databaseMigrationsAfter(36)).toEqual([...V37_DATABASE_MIGRATIONS, ...V38_DATABASE_MIGRATIONS, ...V39_DATABASE_MIGRATIONS, ...V40_DATABASE_MIGRATIONS, ...V41_DATABASE_MIGRATIONS, ...V42_DATABASE_MIGRATIONS, ...V43_DATABASE_MIGRATIONS]);
