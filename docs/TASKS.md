...
- [x] Rebuild/recreate only the two staging Worker services from the current acceptance revision; both now run `open-geo-console:staging-56eb6cb` with exact OCI revision `56eb6cb946f06848fe7612ad6da79387fce29de9`.
...
- [ ] Deploy and accept one newly generated prospective V3 report containing `source_selection_diagnosis_v1` in protected staging; verify authorized desktop/mobile Section 03 rendering, historical fallback, private readiness and unchanged commercial settlement.
