...
- [ ] Reconcile the production deep Worker deployment with schema v25 only after explicit production authorization. Its preserved image `028901e0e5e3` rejects the newer database schema and restart-loops; production free and commerce remain running.
