...
- [ ] Review the approved adaptive public-source acquisition design, then create its implementation plan. No retrieval, schema, answer-contract, recovery, or commercial behavior from the design is implemented yet.
