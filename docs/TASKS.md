...
- [x] Complete a fully answered paid V3 acceptance: report `f764a24d-2bd8-4714-99fc-c7ad754753ff` has three answered `generative_search_v1` cards, 20/19/20 same-response sources, answer-before-sources browser acceptance, active replacement artifact `5d0a1d39-0b75-403f-a59f-b32e2d9bb77c`, private 46-page readiness, delivered email, and a clean commercial audit.
...
- [x] Deploy and accept prospective V3 report `4b4e71b8-c130-4c83-8d4a-e3787ded7009` with `source_selection_diagnosis_v1`: activate replacement artifact `7a891ad9-687f-4ee6-a344-dbb9c8fca157`, render 3 answered cards and 41 source profiles, pass exact-hash desktop/mobile canonical QA without overflow, preserve private 93-page readiness, and keep delivery/refund truth independent.
