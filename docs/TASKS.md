...
- [ ] Complete a fully answered/deliverable V3 acceptance on a target with independently retrievable direct public evidence. New free report `0631932e-72b8-4c6f-b492-820e2533e23e` and unpaid Sandbox order `98974ea3-369e-43bc-b84b-602d96382b02` are the only current acceptance chain; finish its Airwallex CAPTCHA/payment before expecting a signed-Webhook deep job, and do not reopen or replace earlier terminal failures.
