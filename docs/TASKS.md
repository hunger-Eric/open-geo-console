...
- [ ] Complete one protected-browser paid V3 acceptance after the Preview commerce catalog is ready. The 2026-07-16 deployment and aligned staging Workers are green, but checkout remained fail-closed and the approved historical V3 report was not refreshable under its persisted commercial state; no guard was bypassed.
