...
- Schema v21 supports the prospective answer-first `combined_geo_report_v3` contract, immutable three-card checkpoints, provider-discovery snapshot ancestry, immutable relevant passages and provider claims, and staging-only refresh lineage while preserving all V1/V2 rows.
...
The 2026-07-15 answer-first V3 staging run used new report `98caffd1-c8af-4ceb-88ab-063194ea74b7`, paid order `dee37006-7924-4965-8ef3-181d447f27db`, and deep job `7607a664-05c6-4b47-800e-03d420894aea`. Live recovery exposed and fixed source-local timeout containment, terminal mixed-ledger reuse, interrupted snapshot replacement, metadata-aware snapshot waiting, localized answer-card coverage checkpoints, and target-hostname preservation through language repair. The same job then produced ready non-active revision `ae8f0485-ff26-4457-92bc-3fcd7002e970` with canonical HTML and a 17-page private PDF, but atomically failed delivery because all three answer cards truthfully remained `insufficient`. Credit was refunded, Airwallex Sandbox refund `rfd_hkdmcczsvhkeob5qfmn_0ly540` succeeded, and payment/failure/refund emails were delivered. The active Preview is `https://open-geo-console-7zktxor9e-itheheda-6857s-projects.vercel.app`, and the fixed alias points to it. Production and every prior report remain untouched.
...
- Complete a fully answered Chinese V3 and one new English report; the honest all-insufficient V3 failure/refund path proves fail-closed terminality and private artifact readiness but does not substitute for a customer-deliverable V3 report.
