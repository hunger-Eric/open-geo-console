...
| Worker provider route | `OGC_PROVIDER_PROFILE` (`mimo_native` or `external_search_synthesis`) |
...
| External-search synthesis profile data | `OGC_AI_BASE_URL`, `OGC_AI_API_KEY`, `OGC_AI_MODEL`, `OGC_PUBLIC_SEARCH_ANYSEARCH_BASE_URL`, `OGC_PUBLIC_SEARCH_ANYSEARCH_API_KEY` |
